                ...
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Resep Makan</h1> 
                        ...
                        <ol class="breadcrumb text-uppercase">
                            ...
                            <li class="breadcrumb-item"><a href="/detail-resep">Detail Resep</a></li>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="circle-container" style="margin-top: 20px;">
                            <style>
                                .circle-container {
                                    ...
                                    /* Membuat ruang sejajar antara lingkaran */
                                }
                        ...
                        <div class="circle-container">
                            <div class="circle">350<br> Kalori</div>
                            <div class="circle">30g<br> Protein</div>
                            <div class="circle">53g<br> Karbohidrat</div>
                            <div class="circle">10g<br> Lemak</div>
                        </div>
                    </div>
                    <div class="col-md-6">
